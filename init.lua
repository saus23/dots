...
dap.adapters.cppdbg = {
  id = 'cppdbg',
  type = 'executable',
  command = '/home/saus/.local/share/nvim/mason/packages/cpptools/extension/debugAdapters/bin/OpenDebugAD7',
}
...
vim.api.nvim_set_hl(0, 'DapBreakpoint', { ctermbg=0, fg='#ea6962', bg='#31353f' })
vim.api.nvim_set_hl(0, 'DapLogPoint', { ctermbg=0, fg='#89b482', bg='#31353f' })
vim.api.nvim_set_hl(0, 'DapStopped', { ctermbg=0, fg='#89b482', bg='#31353f' })
